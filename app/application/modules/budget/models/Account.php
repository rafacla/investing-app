<?php (defined('BASEPATH')) OR exit('No direct script access allowed');
	...
	class Account extends MY_Model {
		...
		public function __construct() {
			...
			$this->vwAccounts_distinct = "vw_accounts_distinct";
		}
		...
		public function get_all_distinct($fields = '', $where = array(), $table ='',$limit = '', $order_by = '', $group_by = '', $or_where='') {
			$data = array();
			if ($fields != '') {
				$this->db->select($fields);
			}

			$this->db->from($this->vwAccounts_distinct);
